  ...
  return (
    <main>
      <section className="bg-asp-soft">
        <div className="section grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <a className="btn-primary" href={externalHref(whatsapp, whatsappLink(config?.whatsapp, 'Olá! Gostaria de apoiar o Projeto Santa Dulce dos Pobres.'))} target="_blank" rel="noopener noreferrer">Falar sobre apoio</a>
          </div>
      ...
      <section className="section grid gap-6 md:grid-cols-3">
        ...
        <Box title="Formas de apoio" text="Contato institucional pelo WhatsApp para combinar doações de itens, parcerias, serviços ou participação nos projetos." />
      </section>
      <section className="section pt-0">
        <h2 className="mb-5 text-2xl font-bold text-asp-ink">Fotos do projeto</h2>
