            ...
            <div className="flex flex-wrap gap-3">
              {instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram da Ação Social Paroquial São João Batista"
                  title="Instagram"
              ...
              {youtube && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube da Ação Social Paroquial São João Batista"
                  title="YouTube"
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 text-white transition hover:bg-white/20 hover:border-white/60"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              {facebook && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook da Ação Social Paroquial São João Batista"
                  title="Facebook"
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 text-white transition hover:bg-white/20 hover:border-white/60"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
